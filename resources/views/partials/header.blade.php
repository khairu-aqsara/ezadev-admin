    ...
    <nav class="navbar navbar-static-top" role="navigation">
        ...
        <div class="navbar-custom-menu">
            ...
            {!! Admin::getNavbar()->render() !!}
                ...
                @if(config('admin.navbarmode') == 'simple')

                    <li><a href="{{ admin_url('auth/setting') }}">{{ Admin::user()->name }}</a> </li>
                    <li><a href="{{ admin_url('auth/logout') }}"><i class="fa fa-sign-out"></i></a> </li>

                @elseif(config('admin.navbarmode') == 'full')
                <!-- User Account Menu -->
