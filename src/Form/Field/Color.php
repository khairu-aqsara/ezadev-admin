...
class Color extends Text
{
    protected static $css = [
        '/vendor/ezadev-admin/AdminLTE/plugins/colorpicker/bootstrap-colorpicker.min.css',
    ];

    protected static $js = [
        '/vendor/ezadev-admin/AdminLTE/plugins/colorpicker/bootstrap-colorpicker.min.js',
    ];
