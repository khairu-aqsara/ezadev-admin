...
class MultipleFile extends Field
{
    ...
    protected static $css = [
        '/vendor/ezadev-admin/bootstrap-fileinput/css/fileinput.min.css?v=4.5.2',
    ];
     ...
     */
    protected static $js = [
        '/vendor/ezadev-admin/bootstrap-fileinput/js/plugins/canvas-to-blob.min.js',
        '/vendor/ezadev-admin/bootstrap-fileinput/js/fileinput.min.js?v=4.5.2',
        '/vendor/ezadev-admin/bootstrap-fileinput/js/plugins/sortable.min.js?v=4.5.2',
    ];
