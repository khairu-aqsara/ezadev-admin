...
class TestCase extends BaseTestCase
{
    ...
    public function createApplication()
    {
        ...
        $app->booting(function () {
            ...
            $loader->alias('Admin', \Ezadev\Admin\Facades\Admin::class);
        });

        $app->make('Illuminate\Contracts\Console\Kernel')->bootstrap();

        $app->register('Ezadev\Admin\AdminServiceProvider');
    ...
    protected function setUp(): void
    {
        ...
        $this->app['config']->set('database.connections.mysql.database', env('MYSQL_DATABASE', 'ezadev_admin_test'));
        ...
        $this->artisan('vendor:publish', ['--provider' => 'Ezadev\Admin\AdminServiceProvider']);
...
//        \Ezadev\Admin\Admin::$css = [];
//        \Ezadev\Admin\Admin::$js = [];
//        \Ezadev\Admin\Admin::$script = [];
    }
